    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coversation', to='item.item')),
                ('members', models.ManyToManyField(related_name='coversation', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
